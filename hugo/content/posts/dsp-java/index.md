...
![QPSK demodulation](img/jcsaroyobfqo11zvh3jino1qq7i.png)
...
![lowpass](img/yp4g51xrjxss0v9ho9sqt8rdd4y.png)
...
![agc](img/hcpmhaclhse8f7-ye05iml_sjvi.png)
...
![rrcf](img/42kvsx8xtrx3k14qehe1jziunde.png)
...
![before costas loop](img/it-g9hju18tmhnqq0twuj2qizja.png)
...
![after costas loop](img/um77gdjsnwyirvj1joikwgb8qk4.png)
...
![clock recovery in a nutshell](img/n1i8mli4sagj4lh-qc_6wif7kjw.jpg)

После того как все лишние сэмплы выкинуты, получается хорошее QPSK созвездие.

![clock recovery](img/cxrwwpey0e-solb-mig03ua1dvs.png)
...
![initial](img/s3bddzcvb9z7te0u7y2hjhyt6ua.png)

Теперь допустим, что мы получили значение в красной точке.

![hard decision](img/nerub3aklfpmzkksbtdbyo0ik90.png)
...
![compare](img/gjnitpweqxobjmifktc5mli_ehu.jpg)
...
![profiling demodulation](img/aeenpwb8z_nfkpg8w8pfl6iqsuo.png)
...
![simd](img/l7ng0x8bwn8-z4fe1001iwsj9gq.png)
