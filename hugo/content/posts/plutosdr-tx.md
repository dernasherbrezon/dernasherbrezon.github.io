...
В конце же, неплохо было бы добавить несколько нулевых байтов, чтобы [NRZI кодирование](https://ru.wikipedia.org/wiki/NRZI) пакета корректно выдала самые последние биты фрейма.
