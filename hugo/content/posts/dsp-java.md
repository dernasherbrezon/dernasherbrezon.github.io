...
Итак, нужно демодулировать QPSK сигнал на Java. То ли никому это неинтересно, то ли [Java медленная](https://habrahabr.ru/company/jugru/blog/280420/), но я не нашёл ни одной библиотеки, которые бы это делали. Поэтому я взял [существующий](https://github.com/otti-soft/meteor-m2-lrpt) проект демодуляции QPSK сигнала для GNURadio и начал переписывать блоки на Java.

![QPSK demodulation](jcsaroyobfqo11zvh3jino1qq7i.png)
...
![lowpass](yp4g51xrjxss0v9ho9sqt8rdd4y.png)
...
![agc](hcpmhaclhse8f7-ye05iml_sjvi.png)
...
![rrcf](42kvsx8xtrx3k14qehe1jziunde.png)
...
![before costas loop](it-g9hju18tmhnqq0twuj2qizja.png)
...
![after costas loop](um77gdjsnwyirvj1joikwgb8qk4.png)
...
![clock recovery in a nutshell](n1i8mli4sagj4lh-qc_6wif7kjw.jpg)

После того, как все лишние сэмплы выкинуты, получается хорошее QPSK созвездие.

![clock recovery](cxrwwpey0e-solb-mig03ua1dvs.png)
...
![initial](s3bddzcvb9z7te0u7y2hjhyt6ua.png)

Теперь допустим, что мы получили значение в красной точке.

![hard decision](nerub3aklfpmzkksbtdbyo0ik90.png)
...
![compare](gjnitpweqxobjmifktc5mli_ehu.jpg)
...
![profiling demodulation](aeenpwb8z_nfkpg8w8pfl6iqsuo.png)
...
![simd](l7ng0x8bwn8-z4fe1001iwsj9gq.png)
