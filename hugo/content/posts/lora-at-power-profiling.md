 ...
 * Если сравнивать RFO_LF и RFO_HF, то видно, что потребление тока на частоте 140.200Мгц выше. Видимо, на этих частотах антенна [не согласована](https://ru.wikipedia.org/wiki/Коэффициент_стоячей_волны) больше.
