...
{{< chartjs url="/static/img/lora-at-power-profiling/fsk-baud.json" id="fskBaud" title="Зависимость потребления энергии от скорости передачи (FSK)" 
...
{{< chartjs url="/static/img/lora-at-power-profiling/lora-bandwidth-sf.json" id="loraBandwidthSf" title="Зависимость потребления энергии от скорости передачи (LoRa)" 
